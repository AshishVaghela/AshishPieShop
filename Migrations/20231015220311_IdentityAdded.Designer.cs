...
namespace AshishPieShop.Migrations
{
    ...
    [Migration("20231015220311_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AshishPieShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("AshishPieShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("AshishPieShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("AshishPieShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AshishPieShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("AshishPieShop.Models.OrderDetail", b =>
                {
                    b.HasOne("AshishPieShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AshishPieShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AshishPieShop.Models.Pie", b =>
                {
                    b.HasOne("AshishPieShop.Models.Category", "Category")
                        .WithMany("Pies")
